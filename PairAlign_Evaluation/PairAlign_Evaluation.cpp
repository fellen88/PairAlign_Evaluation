...
int main(int argc, char **argv)
{
	...
	reader.read(argv[1], *source);
	reader.read(argv[2], *target);
	...
	view->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 2, "sources_cloud_v2");
	view->spin();
