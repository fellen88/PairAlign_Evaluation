...
{
  PointCloudVisualizer::PointCloudVisualizer(bool DebugVisualizer)
	{
	...
	void PointCloudVisualizer::showCloudsLeft(const PointCloud::Ptr cloud_target, const PointCloud::Ptr cloud_source)
	{
	...
	void PointCloudVisualizer::showCloudsRight(const PointCloudWithNormals::Ptr cloud_target, const PointCloudWithNormals::Ptr cloud_source)
	{
